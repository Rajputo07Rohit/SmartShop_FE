  ...
  return (
    <div className="grid place-items-center min-h-[75vh]">
      ...
      >
        ...
        <p className="text-sm text-gray-400 text-center mb-4">Join ShopSmart — quick and secure.</p>
        ...
        <p className="text-sm text-gray-400 mt-4 text-center">Already have an account? <Link to="/login" className="underline underline-offset-4">Sign in</Link></p>
      </motion.div>
    </div>
  );
}
